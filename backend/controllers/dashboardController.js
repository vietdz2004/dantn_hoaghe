  ...
  try {
    const overviewQuery = `
      SELECT 
        ...
        (SELECT COUNT(*) FROM donhang WHERE trangThaiDonHang = 'CHO_XAC_NHAN') as pendingOrders,
...
exports.getTopProducts = async (req, res) => {
  try {
    ...
    const topProductsQuery = `
      ...
      LEFT JOIN donhang o ON od.id_DonHang = o.id_DonHang AND o.trangThaiDonHang = 'DA_GIAO'
